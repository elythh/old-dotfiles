...
awful.spawn("betterlockscreen -w dim", false)
awful.spawn("source ~/.fehbg", false)
awful.spawn("nm-applet", false)
awful.spawn("feh --no-fehbg --bg-fill '/home/gwen/.config/awesome/theme/dark/wallpapers/6c8sflehi3991.pngspawn'")
