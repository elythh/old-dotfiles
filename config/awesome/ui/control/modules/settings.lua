...
local wifibtn =
	createButton("󰤨", "󰤮", "Network", "network", "awesome-client 'awesome.emit_signal(\"settings::wifi\")'", 70)
local bluetooth = createButton(
	"󰂯",
	"󰂲",
	"Bluetooth",
	"bluetooth",
	"~/.config/awesome/ui/control/scripts/bluetooth --toggle",
	70
)
local dnd = createButton(
	"󰍶",
	"󱑙",
	"Silence",
	"dnd",
...
local airplane = createButton(
	"󰀝",
	"󰀞",
	"Airplane",
	"airplane",
	"~/.config/awesome/ui/control/scripts/airplanemode --toggle",
	70
)
